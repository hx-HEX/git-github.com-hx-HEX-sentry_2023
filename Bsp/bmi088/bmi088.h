...
#define  GYRO_DISABLE   HAL_GPIO_WritePin(Open_SPIx_CSB2_PORT, Open_SPIx_CSB2_PIN, GPIO_PIN_SET)
#define  GYRO_ENABLE   HAL_GPIO_WritePin(Open_SPIx_CSB2_PORT, Open_SPIx_CSB2_PIN, GPIO_PIN_RESET)
#define  ACC_DISABLE    HAL_GPIO_WritePin(Open_SPIx_CSB1_PORT, Open_SPIx_CSB1_PIN, GPIO_PIN_SET)
#define  ACC_ENABLE    HAL_GPIO_WritePin(Open_SPIx_CSB1_PORT, Open_SPIx_CSB1_PIN, GPIO_PIN_RESET)
...
// sentry robot
#define GYRO_X_OFFSET             0.00344224297
#define GYRO_Y_OFFSET             -0.00323739974
#define GYRO_Z_OFFSET             0.00038994482
...
#define OFFSET_CALIBRATE_TIMES    1000000
...
public:
    ...
    inline void SetSPIHandle(SPI_HandleTypeDef* hspi) { m_hspi = hspi; };
